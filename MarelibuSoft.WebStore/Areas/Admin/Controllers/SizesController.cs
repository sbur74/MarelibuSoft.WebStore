...
namespace MarelibuSoft.WebStore.Areas.Admin.Controllers
{
	...
	public class SizesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SizeID,Name,Description")] Size size)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SizeID,Name,Description")] Size size)
        {
            if (id != size.SizeID)
            {
                return NotFound();
