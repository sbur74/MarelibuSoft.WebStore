...
namespace MarelibuSoft.WebStore.Areas.Admin.Controllers
{
	...
	public class UnitsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UnitID,Name,LongName")] Unit unit)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var unit = await _context.Units.SingleOrDefaultAsync(m => m.UnitID == id);
            if (unit == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UnitID,Name,LongName")] Unit unit)
        {
            if (id != unit.UnitID)
            {
                return NotFound();
